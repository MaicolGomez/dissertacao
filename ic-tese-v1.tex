...
First of all, I want to thank God, my family for their constant and unconditional support. To my adviser Prof. Guido and co-adviser Prof. Marcio for the constant help and advice during these two years to be able to finish this work. To the panel to accept the invitation and for their time provided.
...
Lines $37$ to $46$ define the neutral value according to the operation defined by the programmer.
...
In the code \rlst{radcode}, line 7 indicates the traversal of  every bit, which, depending on the
...
in the step 1, and also generates the opposite vector (see lines 12 -- 13). 
The following lines (17 -- 25) compute the scan operator for the vector 
