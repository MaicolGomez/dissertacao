...
The GPGPU programming landscape has rapidly evolved over the past several years, so that now there are several approaches to programming GPUs. For this section, CUDA language will be taken as an example.
