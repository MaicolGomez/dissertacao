...
block~\ding{182} using  the algorithm  proposed by Harris explained in ~\rsec{ScanAlg}.   During the
...
Line $18$ creates an auxiliary buffer (as shown in \rfig{scheme} ~\ding{183}).  Lines $19$ to $25$
