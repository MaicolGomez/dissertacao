...
\definecolor{mycolor}{rgb}{0.20,0.80,0}
...
\begin{abstract}
  ...
  libraries  that provide  hand-parallelized  implementations  of scan
  in  CUDA and OpenCL,  no automatic parallelization solution exist 
  to this operator in  OpenMP. This work proposes a new  clause
  to OpenMP which  enables  the  automatic synthesis of 
...
representation, in \rlst{radexample} is showed a visual representation of how the algorithm works.
\begin{figure}[t]
	\lstset{basicstyle=\scriptsize}
