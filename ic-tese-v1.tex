...
The contribution of this work was published in the following conference paper:
...
\begin{itemize}
  \item M. Gomez, M. Pereira, X. Martorell, and G. Araujo. {\em Automatic scan
    ...
    85–90, Oct 2017.~\cite{maicol2017}.
\end{itemize}
...
Now let us look at an example to see how it works. Suppose that it is necessary
to evaluate the polynomial $x^{3} + x^{2} + 1$ when $x$ is 2. In this case, the
coefficients of the polynomial can be represented using the array $<1, 1, 0,
1>$. The first step of the algorithm is to convert it into an array of pairs.
